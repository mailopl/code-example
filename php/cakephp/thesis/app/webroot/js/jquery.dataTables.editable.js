...
* @sUpdateHttpMethod                String      Method used for the Update AJAX request (default is 'POST')
    ...
    $.fn.makeEditable = function (options) {
        ...
        function fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                event: 'dblclick',
                method: properties.sUpdateHttpMethod,
...
/*
    ...
    function fnUpdateRowOnSuccess(nActionForm) {
        ...
        var defaults = {
            ...
            sAddNewRowButtonClass: "btn btn-primary",
            sDeleteRowButtonClass: "btn btn-danger",
        ...
        return this.each(function () {
            ...
            if (oAddNewRowForm.length != 0) {
                ...
                if (oCancelRowAddingButton.length == 0) {
                    ...
                    properties.oAddNewRowCancelButtonOptions.class = "btn";
                ...
                if (oConfirmRowAddingButton.length == 0) {
                    ...
                    if (properties.oAddNewRowOkButtonOptions.text == null
                        ...
                        properties.oAddNewRowOkButtonOptions.text = "Add row";
                    }
                    properties.oAddNewRowOkButtonOptions.class = "btn btn-primary";
            ...
            if (oAddDeleteToolbar.length != 0) {
                if (oAddNewRowButton == null && properties.sAddNewRowButtonId != ""
                    && oAddNewRowForm != null) {
                    oAddDeleteToolbar.append("<button id='" + properties.sAddNewRowButtonId + "' class='"+ properties.sAddNewRowButtonClass +"'>Add</button> ");
                    oAddNewRowButton = $("#" + properties.sAddNewRowButtonId);
                    oAddNewRowButton.click(function () { oAddNewRowForm.dialog('open'); });
                }
                if (oDeleteRowButton == null && properties.sDeleteRowButtonId != "") {
                    oAddDeleteToolbar.append("<button id='" + properties.sDeleteRowButtonId + "' class='"+ properties.sDeleteRowButtonClass+"'>Delete</button>");
                    oDeleteRowButton = $("#" + properties.sDeleteRowButtonId);
                    oDeleteRowButton.click(_fnOnRowDelete);
                }
            }
