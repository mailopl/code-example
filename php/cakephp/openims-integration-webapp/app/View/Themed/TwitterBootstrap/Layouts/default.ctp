...
<?php
	...
	echo $this->Html->css('bootstrap');
      ...
      echo $this->Html->css('dt.bootstrap.css');
      echo $this->Html->css('jquery-ui-1.8.16.bootstrap.css');
...
?>
  ...
  <body>
    ...
    echo $this->Html->script('http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.24/jquery-ui.min.js');
    echo $this->Html->script('http://ajax.aspnetcdn.com/ajax/jquery.dataTables/1.9.4/jquery.dataTables.js');
    echo $this->Html->script('jquery.jeditable.js');
    echo $this->Html->script('jquery.dataTables.editable.js');
    echo $this->Html->script('http://jquery-datatables-editable.googlecode.com/svn/trunk/media/js/jquery.validate.js');
